...
export default function AuthModalWrapper({ isOpen, onClose, children }) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black bg-opacity-30 flex justify-center items-center p-5 ">
      <div className="bg-white border border-primary-dark border-opacity-50  p-2 rounded-lg shadow-sm w-fit overflow-y-auto h-fit max-h-full scrollbar-hide relative">
        <button
          onClick={onClose}
